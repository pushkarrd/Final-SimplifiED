...
export default function LecturePage() {
  ...
  return (
    <div className="min-h-screen relative bg-black overflow-hidden">
      ...
      {/* Main Content */}
      <div className="min-h-screen px-3 sm:px-4 md:px-6 lg:px-8 py-6 md:py-8">
        <div className="w-full mx-auto max-w-7xl">
          ...
          >
            <div>
              <h1 className={`text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black mb-2 ${isDark ? 'text-white' : 'text-white'}`}>
                New Lecture
              </h1>
              <p className={`text-base sm:text-lg ${isDark ? 'text-gray-300' : 'text-gray-100'}`}>
